...
<template>
     <div class="w-full relative z-50">
          ...
          <div ref="openCoin_list">
            <div v-if="dropOptions" class="bg-slate-100 dark:border dark:border-slate-600 absolute w-full h-[50vh] overflow-y-auto rounded-md dark:bg-slate-800 flex flex-col px-3 py-2 cursor-pointer mt-1">
              <p @click="keep()">BTC</p>
              <p>BTC</p>
              <p>BTC</p>
              <p>BTC</p>
